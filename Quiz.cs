...
namespace Explorer
{
    ...
    public class Quiz : Activity
    {
        ...
        private void initialze()
        {
            ...
            Questions q5 = new Questions(Resource.Drawable.oak, "What tree is this leaf from?", "Ash", "Birch", "Oak", "C");
            ...
            Questions q9 = new Questions(Resource.Drawable.bee, "What insect is this?", "Wasp", "Bee", "Hornet", "A");
